...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        Owner owner2 = new Owner("Homer Simpson", "5551234567", "homer.simpson@simpsons.com", "742 Evergreen Terrace");
        Owner owner3 = new Owner("Jon Snow", "5559876543", "jon.snow@got.com", "Winterfell");
        Owner owner4 = new Owner("Daenerys Targaryen", "5557654321", "daenerys.targaryen@got.com", "Dragonstone");
        Owner owner5 = new Owner("Rick Sanchez", "5552345678", "rick.sanchez@rickandmorty.com", "The Citadel");
        Owner owner6 = new Owner("Jessica Day", "5558765432", "jessica.day@newgirl.com", "Los Angeles, CA");
        Owner owner7 = new Owner("Sherlock Holmes", "5551122334", "sherlock.holmes@sherlockbbc.com", "Baker Street 221B");
        Owner owner8 = new Owner("Eleven", "5553344556", "eleven@strangerthings.com", "Hawkins, Indiana");
        Owner owner9 = new Owner("Michael Scott", "5557788990", "michael.scott@dundermifflin.com", "Scranton, PA");
        Owner owner10 = new Owner("Phoebe Buffay", "5556667778", "phoebe.buffay@friends.com", "New York, NY");
        Owner owner11 = new Owner("The Mandalorian", "5554433221", "mandalorian@starwars.com", "Tatooine");
        Owner owner12 = new Owner("Jim Halpert", "5559871234", "jim.halpert@dundermifflin.com", "Scranton, PA");

        Buyer buyer1 = new Buyer("Yago Sosa", "312547698", "yagososa@example.com", "Av. Libertador 1234");
        Buyer buyer2 = new Buyer("Facundo Aguilera", "2235829879", "facuaguilera32@gmail.com", "Mascias 2069");
        Buyer buyer3 = new Buyer("María López", "3456789012", "mlopez@example.com", "Av. del Libertador 8594");
        Buyer buyer4 = new Buyer("Carlos Pérez", "9876543210", "cperez@example.com", "Calle Ficticia 5678");
        Buyer buyer5 = new Buyer("Lucía Gómez", "1122334455", "lucia.gomez@example.com", "Calle de la Paz 234");
        Buyer buyer6 = new Buyer("Ricardo Rodríguez", "2233445566", "ricardo.rodriguez@example.com", "Av. San Martín 123");
        Buyer buyer7 = new Buyer("Ana María Fernández", "3344556677", "ana.fernandez@example.com", "Calle Belgrano 789");
        Buyer buyer8 = new Buyer("Martín Sánchez", "4455667788", "martin.sanchez@example.com", "Paseo Colón 456");
        Buyer buyer9 = new Buyer("Sofía García", "5566778899", "sofia.garcia@example.com", "Av. Rivadavia 101");
        Buyer buyer10 = new Buyer("Juan Martín López", "6677889900", "juan.martin@example.com", "Calle 9 de Julio 321");
        Buyer buyer11 = new Buyer("Esteban Díaz", "7788990011", "esteban.diaz@example.com", "Calle Rodríguez Peña 543");
        Buyer buyer12 = new Buyer("Cecilia Castro", "8899001122", "cecilia.castro@example.com", "Av. Cabildo 876");

        Tenant tenant1 = new Tenant("Susana Giménez", "01112345678", "susana.gimenez@telefe.com.ar", "Av. Libertador 5000, Buenos Aires");
        Tenant tenant2 = new Tenant("Ricardo Darín", "01187654321", "ricardo.darin@cine.com.ar", "Av. Corrientes 1500, Buenos Aires");
        Tenant tenant3 = new Tenant("Mirtha Legrand", "01123456789", "mirtha.legrand@eltrece.com.ar", "Calle Florida 500, Buenos Aires");
        Tenant tenant4 = new Tenant("Lionel Messi", "03417654321", "leo.messi@barcelona.com", "Rosario, Santa Fe");
        Tenant tenant5 = new Tenant("Mariana Fabbiani", "01134567890", "mariana.fabbiani@eltrece.com.ar", "Calle Rodríguez Peña 200, Buenos Aires");
        Tenant tenant6 = new Tenant("Ángel de Brito", "01165432109", "angel.debrito@eltrece.com.ar", "Av. de Mayo 700, Buenos Aires");
